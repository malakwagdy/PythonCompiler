...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionRun_Parser = new QAction(MainWindow);
        actionRun_Parser->setObjectName("actionRun_Parser");
        actionRun_Parser->setMenuRole(QAction::MenuRole::NoRole);
        ...
        parseTreeTab->setObjectName("parseTreeTab");
        verticalLayoutWidget_6 = new QWidget(parseTreeTab);
        verticalLayoutWidget_6->setObjectName("verticalLayoutWidget_6");
        verticalLayoutWidget_6->setGeometry(QRect(-1, 9, 591, 501));
        verticalLayout_6 = new QVBoxLayout(verticalLayoutWidget_6);
        verticalLayout_6->setObjectName("verticalLayout_6");
        verticalLayout_6->setContentsMargins(0, 0, 0, 0);
        parseTreeView = new QGraphicsView(verticalLayoutWidget_6);
        parseTreeView->setObjectName("parseTreeView");
        parseTreeView->setRenderHints(QPainter::RenderHint::Antialiasing|QPainter::RenderHint::TextAntialiasing);
        parseTreeView->setDragMode(QGraphicsView::DragMode::ScrollHandDrag);

        verticalLayout_6->addWidget(parseTreeView);

        outputTabs->addTab(parseTreeTab, QString());
        ...
        menuCompile->addAction(actionRun_Parser);
        ...
        mainToolBar->addAction(actionRun_Parser);
        mainToolBar->addSeparator();
        mainToolBar->addAction(actionClear_Output);

        retranslateUi(MainWindow);

        outputTabs->setCurrentIndex(3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionRun_Parser->setText(QCoreApplication::translate("MainWindow", "Run &Parser", nullptr));
#if QT_CONFIG(shortcut)
        actionRun_Parser->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+P", nullptr));
#endif // QT_CONFIG(shortcut)
        ...
        outputTabs->setTabText(outputTabs->indexOf(parseTreeTab), QCoreApplication::translate("MainWindow", "Parse Tree", nullptr));
